...
CONFIG_DIR="$HOME/.config/skill-a-create-meeting"
ENV_FILE="$CONFIG_DIR/.env"

echo "🚀 设置 Skill-A (create_meeting)..."
echo ""
...
echo ""
echo "说明："
echo "- LLM 解析由 OpenClaw 负责"
echo "- 腾讯会议创建由 tencent-meeting-skill 负责"
echo "- 邮件发送由 imap-smtp-email 负责"
echo "- Skill-A 只负责 Gitea 目录 / agenda / meta / 日志 / 邮件内容编排"
